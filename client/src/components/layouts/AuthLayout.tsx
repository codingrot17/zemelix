...
export default function AuthLayout({ children, title = "Welcome Back" }: AuthLayoutProps) {
  return (
            ...
            <CardHeader className="text-center">
              <div className="mb-6">
                <img
                  ...
                  className="mx-auto h-20 w-20 object-contain rounded-full shadow-md"
                />
              </div>
              <h2 className="text-2xl font-semibold text-gray-900 dark:text-gray-50">{title}</h2>
            </CardHeader>
