...
const Header = () => {
  ...
  const showShowMore =
    categories.length > MAX_VISIBLE_CATEGORIES && !showAllCategories;
  const showShowLess =
    categories.length > MAX_VISIBLE_CATEGORIES && showAllCategories;
      ...
      <div className="max-w-7xl mx-auto px-4 py-3 flex flex-wrap items-center justify-between gap-y-4">
        ...
        <div className="md:hidden flex items-center space-x-2">
          ...
          <DropdownMenu onOpenChange={setCategoriesOpen}>
            <DropdownMenuTrigger asChild>
              ...
              <Button
                variant="ghost"
                className="flex items-center px-2 text-foreground hover:text-primary"
              >
        ...
        <DropdownMenu onOpenChange={setCategoriesOpen}>
          <DropdownMenuTrigger asChild>
            ...
            <Button
              variant="ghost"
              className="hidden md:flex items-center text-foreground hover:text-primary"
            >
